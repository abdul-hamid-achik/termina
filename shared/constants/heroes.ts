  ...
  cipher: {
    ...
    abilities: {
      ...
      r: {
        ...
        name: 'Brute Force',
        description:
          'Unleash 6 rapid strikes of code damage on a target, applying Encryption Key stacks (-2 defense each, max 4) for 3 cycles.',
        manaCost: 220,
  ...
  null_ref: {
    ...
    abilities: {
      q: {
        ...
        name: 'Void Bolt',
        description:
          "Fire a bolt of void energy that deals code damage and shreds the target's magic resistance by 5 for 3 cycles.",
        manaCost: 55,
