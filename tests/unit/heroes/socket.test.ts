...
function makeState(players: PlayerState[], overrides: Partial<GameState> = {}): GameState {
  ...
  return {
    ...
    zones: {
      ...
      'mid-t1-audit': { id: 'mid-t1-audit', wards: [], waves: [] },
      'top-river': { id: 'top-river', wards: [], waves: [] },
      'cache-top': { id: 'cache-top', wards: [], waves: [] },
      'cache-bot': { id: 'cache-bot', wards: [], waves: [] },
      'audit-fountain': { id: 'audit-fountain', wards: [], waves: [] },
    },
    waves: [],
    ice: [],
    events: [],
